...
$mei_file = $path.'/'.$sub.'/retro_v'.$ver.'_'.$strand.'/ALU/'.$sub.'.ALU.novel.calls';
$ou_file  = $path.'/'.$sub.'/retro_v'.$ver.'_'.$strand.'/ALU/'.$sub.'.stacking.txt';
$all_pe   = $path.'/'.$sub.'/retro_v'.$ver.'_'.$strand.'/ALU/'.$sub.'.ALU.novel.sites';
$all_sr   = $path.'/'.$sub.'/retro_v'.$ver.'_'.$strand.'/'.$sub.'.sr.tabe.discover';
$pe_file = $path.'/'.$sub.'/retro_v'.$ver.'_'.$strand.'/ALU/'.$sub.'.pe.prob3.txt';
$sr_file = $path.'/'.$sub.'/retro_v'.$ver.'_'.$strand.'/ALU/'.$sub.'.sr.prob3.txt';

(open (MEI , "<$mei_file")) || die "cannot open the mei file\n";
